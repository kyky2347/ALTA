...
export function CredentialsCenter({
  ...
  return (
    <Tabs defaultValue="providers" className="capital-workspace">
      <TabsList aria-label={t("connectionCategories")}>
        <TabsTrigger value="providers">{t("researchProviders")}</TabsTrigger>
        <TabsTrigger value="brokers">{t("brokerConnectionsTitle")}</TabsTrigger>
      </TabsList>
        ...
        <section className="credentials-shell">
          <header className="credentials-heading">
            ...
            <div
              ...
              aria-label={t("credentialSummary")}
            >
              <span>
            ...
            <div className="provider-directory">
              ...
              <section className="provider-group">
                ...
                <div className="provider-row is-disabled" aria-disabled="true">
                  ...
                  <span>
                    <strong>
                      {inventory?.trading.provider ?? "Tiger Trade"}
                    </strong>
                    <small>
                      {inventory?.trading.configured
