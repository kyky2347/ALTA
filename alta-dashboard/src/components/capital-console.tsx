    ...
    >
      ...
      <div className="capital-control-plane">
        <div className="capital-gate">
          ...
          {!capital?.configured && (
            <p className="capital-gate-note">{t("capitalConfigRequired")}</p>
          )}
      ...
      <Alert className="paper-boundary-alert">
        ...
        <AlertDescription>{t("paperCapitalBoundaryDetail")}</AlertDescription>
      </Alert>
        ...
        <>
          ...
          <Tabs defaultValue="positions" className="capital-tabs">
            <TabsList variant="line" aria-label={t("brokerSnapshot")}>
              ...
              <TabsTrigger value="audit">{t("capitalAuditTrail")}</TabsTrigger>
            </TabsList>
              ...
              <Table>
                ...
                <TableBody>
                  {snapshot.positions.length ? (
                    ...
                    <EmptyTableRow columns={6} label={t("noPaperPositions")} />
                  )}
                </TableBody>
              </Table>
            </TabsContent>
                  ...
                  {snapshot.orders.length ? (
                    snapshot.orders.map((order) => (
                      <TableRow key={order.reference}>
                        ...
                        <TableCell>{formatMoney(order.limitPrice)}</TableCell>
                        <TableCell>
                          {order.updatedAt
                    ...
                    <EmptyTableRow columns={7} label={t("noRecentOrders")} />
                  )}
                </TableBody>
              </Table>
            </TabsContent>
              ...
              <Table>
                ...
                <TableBody>
                  {capital?.audit.length ? (
                    ...
                    <EmptyTableRow columns={4} label={t("noCapitalAudit")} />
                  )}
                </TableBody>
              </Table>
            </TabsContent>
